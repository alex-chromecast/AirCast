...
/**
 * A communications channel to a receiver application. Messages are not sent and received using the
 ...
 *
 * @param protocolNamespace The namespace for the message.
 * @param message The JSON object containing the message payload.
 */
- (BOOL)sendMessageWithNamespace:(NSString *)protocolNamespace message:(id)message;
